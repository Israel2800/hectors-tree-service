...
export default function ServiceDetail() {
  ...
  return (
    <>
      <PageHero
        imageKey={service.heroImageKey || service.imageKey}
        alt={service.title}
        title={service.title}
        overlayClass="bg-gradient-to-t from-gray-950/85 via-gray-950/50 to-gray-950/25"
        beforeTitle={(
          <>
            <Link
              to="/services"
            ...
            <aside className="space-y-5">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {related.map((item) => {
                    const RelatedIcon = iconMap[item.id] || FaTree
                    ...
                    return (
                      ...
                      >
                        <div className="w-9 h-9 bg-white rounded-lg flex items-center justify-center shadow-sm shrink-0">
                          <RelatedIcon className="w-4 h-4 text-forest-700" />
                        </div>
